...
export default class Renderer {
    ...
    render(currentTime: number) {
        ...
        this.gl.clearColor(this.scene.backgroundColor[0],
            ...
            this.scene.backgroundColor[2], 1.0);
    ...
    renderViewerRayTraced(viewProjectionMatrix: mat4, currentTime: number) {
        ...
        let ray00: vec3 = vec3.subtract(vec3.create(), vec3.fromValues(ray00_i2[0], ray00_i2[1], ray00_i2[2]), this.camera.eye);
        let ray01: vec3 = vec3.subtract(vec3.create(), vec3.fromValues(ray01_i2[0], ray01_i2[1], ray01_i2[2]), this.camera.eye);
        let ray10: vec3 = vec3.subtract(vec3.create(), vec3.fromValues(ray10_i2[0], ray10_i2[1], ray10_i2[2]), this.camera.eye);
        let ray11: vec3 = vec3.subtract(vec3.create(), vec3.fromValues(ray11_i2[0], ray11_i2[1], ray11_i2[2]), this.camera.eye);
