...
export default class Controls {
    constructor(globalState, camera, scene) {
        ...
        this.moveHandler = (e) => {
            ...
            const start = vec3.transformMat4(vec3.create(), vec3.fromValues(clipX, clipY, -1), this.globalState.viewProjectionInverse);
            const end = vec3.transformMat4(vec3.create(), vec3.fromValues(clipX, clipY, 1), this.globalState.viewProjectionInverse);
        ...
        this.toggleToViewer = () => {
            ...
            this.globalState.transitioning = true;
            this.globalState.transitionTime = 0;
            let yRange = this.scene.cubeSpace.populateBuffers();
        ...
        this.colorisPickHandler = (e) => {
            ...
            if (this.colorMode == COLOR_MODE.CUBE) {
                let hoverCubeColor = vec3.fromValues(rgbArray[0] / 255, rgbArray[1] / 255, rgbArray[2] / 255);
        ...
        this.openEditorButtonClickHanlder = () => {
            let editorPaneElement = document.getElementById("editorPane");
            if (editorPaneElement != null) {
                editorPaneElement.style.display = "block";
            }
        };
        this.modelLoadButtonClickHandler = () => {
        ...
        this.cubeColorClickHandler = () => {
            this.colorMode = COLOR_MODE.CUBE;
        };
        this.backgroundColorClickHandler = () => {
    ...
    registerControls() {
        ...
        (_a = document.getElementById("downloadButton")) === null || _a === void 0 ? void 0 : _a.addEventListener('click', this.downloadButtonClickHandler, false);
        (_b = document.getElementById("toggleSunButton")) === null || _b === void 0 ? void 0 : _b.addEventListener('click', this.toggleSunButtonClickHandler, false);
        (_c = document.getElementById("closeEditorButton")) === null || _c === void 0 ? void 0 : _c.addEventListener('click', this.closeEditorButtonClickHandler, false);
        (_d = document.getElementById("openEditorButton")) === null || _d === void 0 ? void 0 : _d.addEventListener('click', this.openEditorButtonClickHanlder, false);
        (_e = document.getElementById("modelLoadButton")) === null || _e === void 0 ? void 0 : _e.addEventListener('click', this.modelLoadButtonClickHandler, false);
